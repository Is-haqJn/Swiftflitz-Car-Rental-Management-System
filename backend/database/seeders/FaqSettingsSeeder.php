...
class FaqSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings->banner_title = "FAQ's";
        $settings->faq_section_enabled = true;
        $settings->faq_section_large_title = 'Frequently Asked Questions';
        $settings->faq_items = [
            [
        ...
        $this->command->info('FAQ settings seeded successfully.');
    }
}

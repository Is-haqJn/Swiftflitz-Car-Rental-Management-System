...
@section('title', 'Chauffeur Booking Confirmed')

@section('preheader', 'Your chauffeur booking has been received and is being processed.')

@section('content')
    <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin-bottom: 6px;">Booking Confirmed!</h1>
    <p style="color: #6b7280; font-size: 14px; margin-bottom: 16px;">
        Hi {{ $customerName }}, your chauffeur booking has been received. We'll notify you once it's confirmed.
    </p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; margin-bottom: 28px;">
        ...
        <tr>
            <td style="font-size: 13px; color: #6b7280; padding: 10px 0 4px; width: 40%;">Pickup Time</td>

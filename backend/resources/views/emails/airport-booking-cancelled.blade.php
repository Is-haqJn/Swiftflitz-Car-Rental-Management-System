...
@section('title', 'Airport Transfer Booking Cancelled')

@section('preheader', 'Your airport transfer booking has been cancelled.')

@section('content')
    <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin-bottom: 6px;">Booking Cancelled</h1>
    <p style="color: #6b7280; font-size: 14px; margin-bottom: 16px;">
        Hi {{ $customerName }}, your airport transfer booking has been cancelled.
    </p>

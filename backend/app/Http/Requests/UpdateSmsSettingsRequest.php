...
class UpdateSmsSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'default_provider' => ['sometimes', 'string', 'in:arkessel,twilio,nalo,hubtel'],
            ...
            'arkessel_api_key' => ['sometimes', 'nullable', 'string', 'max:500'],
            'arkessel_sender_id' => ['sometimes', 'nullable', 'string', 'max:100'],
            'twilio_account_sid' => ['sometimes', 'nullable', 'string', 'max:100'],
            'twilio_auth_token' => ['sometimes', 'nullable', 'string', 'max:500'],
            'twilio_from_number' => ['sometimes', 'nullable', 'string', 'max:30'],
            'nalo_api_key' => ['sometimes', 'nullable', 'string', 'max:500'],
            'nalo_sender_id' => ['sometimes', 'nullable', 'string', 'max:100'],
            'hubtel_sms_client_id' => ['sometimes', 'nullable', 'string', 'max:200'],
            'hubtel_sms_client_secret' => ['sometimes', 'nullable', 'string', 'max:500'],
            'hubtel_sms_sender_id' => ['sometimes', 'nullable', 'string', 'max:100'],
        ];
    }
}

...
import type { PrivacySettingsData } from '@/shared/types';
import {
    usePrivacySettings,
    useUpdatePrivacySettings,
    useUploadPrivacyBannerImage,
...
const BANNER_IMAGE_PATH = '/assets/images/privacy-banner.jpg';
...
function BannerSectionCard({
    ...
    const uploadBannerMutation = useUploadPrivacyBannerImage();
    ...
    const {
        ...
        setError,
        formState: { errors },
    } = useForm<PrivacySettingsData>({ defaultValues: initialData });
                        ...
                        <Col md={12}>
                            <Form.Group>
                                ...
                                <Form.Text className="text-muted">
                                    Heading displayed on the Privacy Policy page
                                    banner
                                </Form.Text>
...
export default function PrivacyContent() {
    const title = useTitle('Privacy Policy Page');
        ...
        <div className="pb-4">
            ...
            <div className="page-titles mb-3">
                ...
                <p className="text-muted mb-0">
                    Manage the banner and content of the Privacy Policy page.
                </p>
            </div>
